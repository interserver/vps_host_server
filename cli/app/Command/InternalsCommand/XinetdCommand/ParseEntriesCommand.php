<?php
namespace App\Command\InternalsCommand\XinetdCommand;
...
*/
class ParseEntriesCommand extends Command
{
	public function brief() {
		return "parses all the files in /etc/xinetd.d loading all service defintions into a nicely structured array";
	}
