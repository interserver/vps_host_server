...
*/
class GetAssignmentsCommand extends Command
{
	public function brief() {
		return "gets a list of assignment operators used in an xinetd service defintion";
	}
	...
	public function execute() {
		...
		$response = Xinetd::getAssignments();
		if ($json == true) {
