...
class AddIpCommand extends Command {
	public function brief() {
		return "AddIps a Virtual Machine.";
	}
...
*/
	...
	public function addIpVps($hostname) {
		$this->getLogger()->info('AddIpping the VPS');
		...
		$sleepTime = 10;
		$continue = true;
		while ($waited <= $maxWait && $addIpped == false) {
			if (Vps::isVpsRunning($hostname)) {
